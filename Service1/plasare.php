...
$insert = "INSERT INTO cereri(ID, TextUtilizator, StatusCerere, DataDorita,OraDorita, IdCont,Raspuns, imagename, poza) VALUES ('$id_max','$cerere','$stat','$date','$time','$id','$raspuns', '$imagename', '$imgData')";
